...
export async function generateExplanation(topic: string) {
  ...
  try {
    ...
    const prompt = [
      `Provide a comprehensive, high-depth explanation of "${topic}" for a curious student.`,
      "Structure your response with the following sections:",
      "1. **The Core Concept**: A clear, sophisticated but accessible definition.",
      "2. **How it Works**: Explain the underlying mechanisms or principles in detail. Go beyond the surface level.",
      "3. **Why it Matters**: Discuss the significance, real-world applications, or its place in the broader field of study.",
      "4. **A Deep-Dive Example**: Provide a detailed, illustrative example that clarifies a complex aspect of the topic.",
      "",
      "Constraints:",
      "- Aim for 250-400 words to ensure sufficient depth.",
      "- Use professional yet engaging language.",
      "- Maintain clarity while embracing complexity where necessary.",
      "- Use markdown formatting (bolding, lists) to enhance readability.",
    ].join("\n");
